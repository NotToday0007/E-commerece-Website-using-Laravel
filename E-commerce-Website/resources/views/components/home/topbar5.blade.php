...
async function Popular(){
    let res=await axios.get("/Product-by-Remarks/popular");
    $("#PopularItem").empty();
...
New();
async function New (){
    let res=await axios.get("/Product-by-Remarks/new");
    $("#NewItem").empty();
    res.data['data'].forEach((item,i)=>{
        let EachItem=`<div class="col-lg-3 col-md-4 col-6">
                            <div class="product">
...
Top();
async function Top(){
    let res=await axios.get("/Product-by-Remarks/top");
    $("#TopItem").empty();
    res.data['data'].forEach((item,i)=>{
        let EachItem=`<div class="col-lg-3 col-md-4 col-6">
                            <div class="product">
...
async function Special(){
    let res=await axios.get("/Product-by-Remarks/special");
    $("#SpecialItem").empty();
...
async function Trending(){
    let res=await axios.get("/Product-by-Remarks/trending");
    $("#TrendingItem").empty();
    res.data['data'].forEach((item,i)=>{
        let EachItem=`<div class="col-lg-3 col-md-4 col-6">
                            <div class="product">
